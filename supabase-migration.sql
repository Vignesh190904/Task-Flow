...
-- If you have existing users, you can manually create their profiles
-- Replace 'your-user-id' with actual user IDs from auth.users table
-- INSERT INTO profiles (id, full_name, email, avatar_url) VALUES 
--   ('3bebdd97-d0b3-4a24-961d-69130a79a8be', 'Your Name', 'your-email@example.com', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Felix'); 